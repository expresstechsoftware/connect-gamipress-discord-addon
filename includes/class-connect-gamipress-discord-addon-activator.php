...
class Connect_Gamipress_Discord_Addon_Activator {
	...
	public static function activate() {
		...
		update_option( 'ets_gamipress_discord_welcome_message', 'Hi [GP_STUDENT_NAME] ([GP_STUDENT_EMAIL]), Welcome, Your ranks [GP_RANKS] at [SITE_URL] Thanks, Kind Regards, [BLOG_NAME]' );                
